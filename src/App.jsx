...
function App() {
  ...
  // We use this to decide the color based on vote counts
  const calculateStatus = (votes) => {
    ...
    // Default fallback (if no votes yet)
  ...
  const setupPopupInteraction = () => {
    ...
    map.current.on('click', 'places-dots', (e) => {
        ...
        // ✏️ UPDATE: Labels changed from C/E/$ to Cash/EC/Card
        popupNode.innerHTML = `
  ...
  return (
    <div className="map-wrap">
      ...
      <div className="search-bar" style={{top: '80px'}}>
        <input 
          type="text" 
          placeholder="Search Munich..." 
